		...
		<form action="/user/join.do" method="post">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="userResNum_front"
					name="userResNum_front" style="width: 48%; display: inline-block;">
				<label for="userResNum_rear" style="display: inline-block;">
					- </label> <input type="text" class="form-control" id="userResNum_rear"
					name="userResNum_rear" style="width: 48%; display: inline-block;">
			</div>
