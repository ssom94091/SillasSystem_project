...
public class UserController {
	...
	@Resource(name = "ContractService3")
	private ContractService3 ContractService3;

	@Resource(name = "ContractService4")
	private ContractService4 ContractService4;
	...
	// 계약서1 DB 전송 void로 했음;; 안되면 string return
	...
	public String trmTemplate2(@ModelAttribute ContractVO2 vo) throws Exception {
		ContractService2.trmTemplate2(vo);
	...
	public String trmTemplate3(@ModelAttribute ContractVO3 vo) throws Exception{
		ContractService3.trmTemplate3(vo);
	...
	public String trmTemplate4(@ModelAttribute ContractVO4 vo) throws Exception {
		ContractService4.trmTemplate4(vo);
