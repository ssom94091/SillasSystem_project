...
<div class="container">
   <div class="row">
      ...
      <form action="/ec/template/contractChk.do" method="post">  <!-- 자기자신에게 input에 입력된 값을 보낸다. -->
      <div class="col-sm-12">
      ...
      <input type="checkbox" id="employment_insurance" value="1"><label for="employment_insurance">고용보험</label>
      <input type="checkbox" id="accident_insurance" value="1"><label for="accident_insurance">산재보험</label>
      <input type="checkbox" id="national_pension" value="1"><label for="national_pension">국민연금</label>
      <input type="checkbox" id="health_insurance" value="1"><label for="health_insurance">건강보험</label></div><br><br>
      <div class="col-sm-12">
      ...
      <canvas class="sign-canvas" id="sign-canvas" style="float:left;">서명칸</canvas>
