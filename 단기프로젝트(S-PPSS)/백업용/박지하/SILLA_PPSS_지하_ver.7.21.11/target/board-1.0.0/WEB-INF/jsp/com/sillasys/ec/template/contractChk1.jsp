...
<div class="container">
   <div class="row">
      ...
      <input type="text" id="company_num" name="company_num" value=<%=company_num %> style="width:110px;height:30px;display:inline-block;">)<br>주 소:
...
window.onload=function(){
    ...
    logt = document.getElementById("admin_id");
