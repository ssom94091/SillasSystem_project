...
public class EcVO {
	...
	public String toString() {
		return "EcVO [contarct_pk=" + contarct_pk + ", user_id=" + user_id + ", admin_id=" + admin_id + ", start_year="
				+ start_year + ", start_month=" + start_month + ", start_day=" + start_day + ", work_place="
				+ work_place + ", content=" + content + ", work_per_week=" + work_per_week + ", holiday=" + holiday
				+ ", pay_type=" + pay_type + ", pay=" + pay + ", bonus=" + bonus + ", payday=" + payday + ", payfor="
				+ payfor + ", em_insurance=" + em_insurance + ", ac_insurance=" + ac_insurance + ", pension=" + pension
				+ ", hlt_insurance=" + hlt_insurance + ", canvas=" + canvas + ", contract_year=" + contract_year
				+ ", contract_month=" + contract_month + ", contract_day=" + contract_day + ", admin_name=" + admin_name
				+ ", extra_pay=" + extra_pay + ", create_date=" + create_date + ", modify_date=" + modify_date + "]";
	}
