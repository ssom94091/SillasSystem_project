...
public class UserController {
	 ...
	 * // 계약서1 DB 전송
	 * 
	 * @RequestMapping(value = "/contract/template/contract1.do", method =
	 * RequestMethod.POST) public String trmTemplate1(@ModelAttribute ContractVO
	 * vo, @ModelAttribute ContractWorkTimeVO vo2, @ModelAttribute ContractBenefitVO
	 * vo3,@ModelAttribute ContractEndTimeVO vo4) throws Exception {
	 * 
	 * ContractService.trmTemplate1(vo); ContractService.trmTemplateWork(vo);
	 * ContractService.trmTemplateEnd(vo); ContractService.trmTemplateBenefit(vo);
	 * 
