...
public class ContractWorkVO {
	...
	public String toString() {
		return "ContractWorkVO [contract_pk=" + contract_pk + ", start_hour=" + start_hour + ", start_min=" + start_min
				+ ", end_hour=" + end_hour + ", end_min=" + end_min + ", b_start_hour=" + b_start_hour
				+ ", b_start_min=" + b_start_min + ", b_end_hour=" + b_end_hour + ", b_end_min=" + b_end_min
				+ ", work_day=" + work_day + ", work_time=" + work_time + ", flag=" + flag + "]";
	}
