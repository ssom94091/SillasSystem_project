...
<div class="container">
   <div class="raw">
 	  <div class="nav" style="float:right;">
		<a href="/user/index.do"><img src="/images/silla/login_silla_logo.png" style="float:right;"></a>
	</div>
      <form method="post" action="writeAction.jsp">
         ...
         <iframe src="../ec/template/contract4.do" style="width:100%;height:100vh;padding:20px;"></iframe>
