...
<div class="container">
   <div class="row">
      ...
      <input type="text" id="benefit" name="benefit_1" style="width:150px;height:30px;display:inline-block;margin:2px;">원(내역별 기재), 없음
...
<script type="text/javascript">
   ...
   function Check() {
		if(document.frm.admin_id.value==""||document.frm.user_id.value==""||document.frm.start_year.value==""||document.frm.start_month.value==""||document.frm.start_day.value==""
				||document.frm.location.value==""||document.frm.contents.value==""||document.frm.work_day_1.value==""||document.frm.work_day_2.value==""||document.frm.work_day_3.value==""||document.frm.work_day_4.value==""
				||document.frm.work_day5.value==""||document.frm.work_day_6.value==""||document.frm.work_time_1.value==""||document.frm.work_time_2.value==""||document.frm.work_time_3.value==""
				||document.frm.work_time_4.value==""||document.frm.work_time_5.value==""||document.frm.work_time_6.value==""||document.frm.work_start_time_1.value==""||document.frm.work_start_time_2.value==""
				||document.frm.work_start_time_3.value==""||document.frm.work_start_time_4.value==""||document.frm.work_start_time_5.value==""||document.frm.work_start_time_6.value==""||document.frm.work_start_min_1.value==""
				||document.frm.work_start_min_2.value==""||document.frm.work_start_min_3.value==""||document.frm.work_start_min_4.value==""||document.frm.work_start_min_5.value==""||document.frm.work_start_min_6.value==""
				||document.frm.work_end_time_1.value==""||document.frm.work_end_time_2.value==""||document.frm.work_end_time_3.value==""||document.frm.work_end_time_4.value==""
				||document.frm.work_end_time_5.value==""||document.frm.work_end_time_6.value==""||document.frm.work_end_min_1.value==""||document.frm.work_end_min_2.value==""||document.frm.work_end_min_3.value==""||document.frm.work_end_min_4.value==""
				||document.frm.work_end_min_5.value==""||document.frm.work_end_min_6.value==""
				||document.frm.break_start_time_1.value==""||document.frm.break_start_time_2.value==""||document.frm.break_start_time_3.value==""||document.frm.break_start_time_4.value==""||document.frm.break_start_time_5.value==""||document.frm.break_start_time_6.value==""
				||document.frm.break_start_min_1.value==""||document.frm.break_start_min_2.value==""||document.frm.break_start_min_3.value==""||document.frm.break_start_min_4.value==""||document.frm.break_start_min_5.value==""||document.frm.break_start_min_6.value==""
				||document.frm.break_end_time_1.value==""||document.frm.break_end_time_2.value==""||document.frm.break_end_time_3.value==""||document.frm.break_end_time_4.value==""||document.frm.break_end_time_5.value==""||document.frm.break_end_time_6.value==""
				||document.frm.break_end_min_1.value==""||document.frm.break_end_min_2.value==""||document.frm.break_end_min_3.value==""||document.frm.break_end_min_4.value==""||document.frm.break_end_min_5.value==""||document.frm.break_end_min_6.value==""
				||document.frm.pay_money.value==""||document.frm.payday.value==""||document.frm.contract_year.value==""||document.frm.contract_month.value==""||document.frm.contract_day.value==""||document.frm.company_name.value==""||document.frm.extra_pay.value==""
			...
			if(document.frm.work_time_1.value==""||document.frm.work_start_time_1.value==""||document.frm.work_start_min_1.value==""
				||document.frm.work_end_time_1.value==""||document.frm.work_end_min_1.value=="") {
			...
			if(document.frm.break_start_time_1.value==""||document.frm.break_start_min_1.value==""
				||document.frm.break_end_time_1.value==""||document.frm.break_end_min_1.value=="") {
