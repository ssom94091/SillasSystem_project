...
<div class="container">
   <div class="row">
      ...
      <form action="/ec/template/contractChk3.do" method="post" name= "frm" onsubmit="return Check()">  <!-- 자기자신에게 input에 입력된 값을 보낸다. -->
...
<script type="text/javascript">
   ...
   function Check() {
		if(document.frm.admin_id.value==""||document.frm.user_id.value==""||document.frm.start_year.value==""||document.frm.start_month.value==""||document.frm.start_day.value==""||document.frm.end_year.value==""||document.frm.end_month.value==""
				||document.frm.end_day.value==""||document.frm.location.value==""||document.frm.contents.value==""||document.frm.work_day_1.value==""||document.frm.work_day_2.value==""||document.frm.work_day_3.value==""||document.frm.work_day_4.value==""
