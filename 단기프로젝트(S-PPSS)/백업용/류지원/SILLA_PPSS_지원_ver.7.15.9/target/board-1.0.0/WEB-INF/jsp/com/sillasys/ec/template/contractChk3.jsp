...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-12" style="margin-top:10px;">
		3. 업무의 내용:
		<input type="text" id="contents" name="location" value=<%=location %> style="width:350px;height:30px;display:inline-block;"></div>
		<div class="col-sm-12" style="margin-top:10px;">
		...
		<div class="col-sm-12">
			<table class="table table-bordered">
				<tr>
					<td></td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_1" name="work_day_1" value=<%=end_month %> style="width:30px;height:30px;display:inline-block;">요일</td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_2" name="work_day_2" value=<%=end_month %> style="width:30px;height:30px;display:inline-block;">요일</td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_3" name="work_day_3" value=<%=end_month %>style="width:30px;height:30px;display:inline-block;">요일</td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_4" name="work_day_4" value=<%=end_month %> style="width:30px;height:30px;display:inline-block;">요일</td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_5" name="work_day_5" value=<%=end_month %> style="width:30px;height:30px;display:inline-block;">요일</td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_6" name="work_day_6" value=<%=end_month %> style="width:30px;height:30px;display:inline-block;">요일</td>
				</tr>
				<tr>
					<td style="text-align:center;padding:0px;">근로시간</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_time_1" name="work_time_1" value=<%=end_month %> style="width:30px;height:30px;display:inline-block;"maxlength="2">시간</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_time_2" name="work_time_2" value=<%=end_month %> style="width:30px;height:30px;display:inline-block;"maxlength="2">시간</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_time_3" name="work_time_3" value=<%=end_month %> style="width:30px;height:30px;display:inline-block;"maxlength="2">시간</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_time_4" name="work_time_4" value=<%=end_month %> style="width:30px;height:30px;display:inline-block;"maxlength="2">시간</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_time_5" name="work_time_5" value=<%=end_month %> style="width:30px;height:30px;display:inline-block;"maxlength="2">시간</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_time_6" name="work_time_6" value=<%=end_month %> style="width:30px;height:30px;display:inline-block;"maxlength="2">시간</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<input type="text" id="work_end_min_6" name="work_end_min_6" value=<%=work_start_time_6 %> style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
				</tr>
				<tr>
		...
		<input type="text" id="contract_day" name="contract_day" value=<%=contract_day %> style="width:30px;height:30px;display:inline-block;"maxlength="4">일<br><br>(사업주) 사업체명:
