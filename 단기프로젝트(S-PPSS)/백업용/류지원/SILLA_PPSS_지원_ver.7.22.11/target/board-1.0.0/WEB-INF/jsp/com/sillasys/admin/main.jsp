      ...
      <button
       ...
       type="button" class="btn_image" id="img_btn2"
        ...
        <div class="col-sm-12" id="content" style="height: auto; min-height: 500px; overflow: auto;   overflow: scroll;">
           <iframe id="iframe_set" src="../contract/content.do" scrolling="yes" style="width:100%; min-height:100vh; border: 1px dashed;" ></iframe>
        </div>
        <form action="/user/write.do" method="post" name="frm" id="frm">
           <input type="hidden" id="index" name="index" value="0">
           <input type="hidden" id="indexu" name="indexu" value="555">
        </form>
    </div>
</div>
