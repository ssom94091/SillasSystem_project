...
public class AdminController {
	...
	/* 로그아웃 */
		...
		/*페이지 이동 맵핑 구간 시작*/
				...
				//근로계약서 목록보기페이지 이동
				@RequestMapping(value = "/ec/list.do" , method = RequestMethod.GET)
				public String goList() {
					return "com/sillasys/ec/list";
				}
				//근로계약서 양식작성페이지 이동
				@RequestMapping(value = "/ec/content.do" , method = RequestMethod.GET)
				public String goContent() {
					return "com/sillasys/ec/content";
				}
				//근로계약서 양식보기페이지 이동
				@RequestMapping(value = "/ec/sample.do" , method = RequestMethod.GET)
			...
			public String goDelete1(@ModelAttribute ContractVO vo) throws Exception {
				ContractService.goDelete1(vo);
			
				return "com/sillasys/admin/main.do";
			}

			/*
			 * @RequestMapping(value = "/admin/main.do", method = RequestMethod.POST) public
			 * String goDelete2(@ModelAttribute ContractVO vo) throws Exception {
			 * ContractService.goDelete2(vo);
			 * 
			 * 
			 * return "com/sillasys/admin/main.do"; }
			 * 
			 * @RequestMapping(value = "/admin/main.do", method = RequestMethod.POST) public
			 * String goDelete3(@ModelAttribute ContractVO vo) throws Exception {
			 * ContractService.goDelete3(vo);
			 * 
			 * 
			 * return "com/sillasys/admin/main.do"; }
			 * 
			 * @RequestMapping(value = "/ec/template/contract3.do", method =
			 * RequestMethod.POST) public String goDelete4(@ModelAttribute ContractVO vo)
			 * throws Exception { ContractService.goDelete4(vo);
			 * 
			 * return "com/sillasys/admin/main.do"; }
			 */
}