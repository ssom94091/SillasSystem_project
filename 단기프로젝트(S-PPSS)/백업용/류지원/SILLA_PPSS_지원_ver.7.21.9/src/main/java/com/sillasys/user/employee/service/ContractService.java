...
public interface ContractService {
	...
	/*
	 * public void goDelete2(ContractVO param) throws Exception; public void
	 * goDelete3(ContractVO param) throws Exception; public void
	 * goDelete4(ContractVO param) throws Exception;
	 */
