...
<div class="container">
   <div class="row">
      ...
      <div class="col-sm-12" style="margin-top:10px;">
      4. 소정근로시간:
      <input type="text" onkeyup="setValue();" id="start_hour" name="start_hour" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
      ...
      <input type="text" onkeyup="setValue();" id="b_start_time" name="b_start_time" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
      ...
      <input type="text" onkeyup="setValue();" id="b_end_time" name="b_end_time" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
      ...
      <select id="work_per_week" onkeyup="setValue();" name="work_per_week" style="width:40px;height:30px;display:inline-block;"onchange="setWPW(this.value)">
        ...
        <div class="col-sm-12">
        6. 임금<br> - 
        <select name="pay_type" onkeyup="setValue();"style="width:60px;height:30px;display:inline-block;">
           <option value="1">월급</option>
           <option value="2">주급</option>
           <option value="3">시급</option>
        </select> : 
        <input type="text" onkeyup="setValue();" id="pay" name="pay" style="width:150px;height:30px;display:inline-block;" onchange="getNumber(this);"
