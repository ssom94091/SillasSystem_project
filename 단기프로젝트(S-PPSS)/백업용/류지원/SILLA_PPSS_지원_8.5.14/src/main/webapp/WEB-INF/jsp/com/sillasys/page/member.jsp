...
function createMember() {
	...
	var popupY = (window.screen.height/2)-(600/2);
		childWindow = window.open("/common/writemember.do?adminId=", "_blank", "width=800, height=600 left="+popupX+",top="+popupY);
...
function deleteProfile(memberPk) {
 ...
 <div class="container-fluid p-0" id="test">
			...
			<div class="col-sm-12" style="text-align: center; ">
				<form action="/page/member.do" method="post">
					Type <select id="search_type" name="search_type"
						style="height: 100%;">
				...
				<form action="#" method="get" id="form_member"name="form_member">
				<button class="btn btn-success" onclick="createMember();" style="float:right; margin-right:23px;">직원추가</button>
				</form>
			</div>
			...
			<div class="container">
			 ...
			 <!-- 카드 리스트 부분 -->
							<c:forEach items="${contentList}" var="contentList" varStatus="status">
								<div class="col-sm-4" style="margin-top:40px; border:1px;">
									<div class="card">
											...
											<div class="card-body">
													...
													<b>나이  </b> <c:out value="${age[status.index]}"/><br>
													<b>주민등록번호     </b> <br><c:out value="${contentList.memberResnumFront}"/>-<c:out value="${list[status.index]}"/><br>
													<b>이메일  </b> <br><c:out value="${contentList.memberEmail}"/></p>
													<hr>
