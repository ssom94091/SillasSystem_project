...
<div class="container">
	...
	<div class="row">
		...
		<form action="/user/index.do" method="post" id="frm" name="frm">
	...
	<c:forEach items="${contentList}" var="contentList">
               <tr style="border-bottom:1px solid">
                  ...
                  <td style="border-left:1px solid"><input type="button" value="<c:out value="${contentList.chk}" default="작성필요"/>" onclick="cont_type_chk('<c:out value="${contentList.contractType}"/>');">
                  	<input type="submit" value="삭제" id=btn_del name=btn_del onclick="cont_delete();"></td>
               </tr>
    </c:forEach>
	</tbody>
		</table>
