		...
		<form action="/user/template/contract1.do" method="post" id="frm1"
			...
			<div class="col-sm-12">
				1. 근로계약기간: <input type="text" onkeyup="setValue();" id="start_year"
					...
					name="start_month" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2"> 월 <input type="text" onkeyup="setValue();"
					id="start_day" value="<c:out value="${contentList.startDay}"/>" 
					
					name="start_day" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2"> 일부터 <input type="text" onkeyup="setValue();"
					id="end_year" value="<c:out value="${endList.endYear}"/>" name="end_year" readonly
					style="width: 60px; height: 30px; display: inline-block;"
					maxlength="4"> 년 <input type="text" onkeyup="setValue();"
					id="end_month" value="<c:out value="${endList.endMonth}"/>" name="end_month" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2"> 월 <input type="text" onkeyup="setValue();"
					id="end_day" value="<c:out value="${endList.endDay}"/>" name="end_day" readonly
					style="width: 30px; height: 30px; display: inline-block;"
			...
			<div class="col-sm-12">
				2. 근무장소: <input type="text" onkeyup="setValue();" id="work_place"
					value="<c:out value="${contentList.workPlace}"/>" name="work_place" readonly
					style="width: 350px; height: 30px; display: inline-block;"
					maxlength="50">
			</div>
			<div class="col-sm-12" style="margin-top: 10px;">
				3. 업무의 내용: <input type="text" onkeyup="setValue();" id="content"
					value="<c:out value="${contentList.content}"/>" name="content" readonly
					style="width: 350px; height: 30px; display: inline-block;"
					maxlength="50">
			</div>
			<div class="col-sm-12" style="margin-top: 10px;">
				4. 소정근로시간: <input type="text" onkeyup="setValue();" id="start_hour"
					value="<c:out value="${workList.startHour}"/>" name="start_hour" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">시 <input type="text" onkeyup="setValue();"
					id="start_min" value="<c:out value="${workList.startMin}"/>" name="start_min" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">분부터 <input type="text" onkeyup="setValue();"
					id="end_hour" value="<c:out value="${workList.endHour}"/>" name="end_hour" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">시 <input type="text" onkeyup="setValue();"
					id="end_min" value="<c:out value="${workList.endMin}"/>" name="end_min" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					...
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">시 <input type="text" onkeyup="setValue();"
					id="b_start_min" value="<c:out value="${workList.bStartMin}"/>" name="b_start_min" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">분~ <input type="text" onkeyup="setValue();"
					id="b_end_hour" value="<c:out value="${workList.bEndHour}"/>" name="b_end_hour" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">시 <input type="text" onkeyup="setValue();"
					id="b_end_min" value="<c:out value="${workList.bEndMin}"/>" name="b_end_min" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">분
			</div>
			<br>
			<br>
			<div class="col-sm-12">
				5. 근무일/휴일:매주 <c:out value="${contentList.workPerWeek}"/><select id="work_per_week" onkeyup="setValue();"
					value="<c:out value="${contentList.workPerWeek}"/>" name="work_per_week" disabled
			...
			<div class="col-sm-12">
				6. 임금<br> - <select id="pay_type" value="<c:out value="${contentList.payType}"/>"
					name="pay_type" onkeyup="setValue();" disabled
					style="width: 60px; height: 30px; display: inline-block;">
				...
				- 상여금:있음 <input type="radio" onkeyup="setValue();" id="bonus_on"
					name="bonus_check" value="1" disabled style="text-align: center"
					onclick="toggle_bonus(true);"> <input type="text" readonly
				...
				등):있음 <input type="radio" onkeyup="setValue();" id="benefit_on"
					...
					onclick="toggle_benefit(true);" disabled>없음 <input type="radio"
					onkeyup="setValue();" id="benefit_off" name="benefit_check"
					value="2" style="text-align: center; margin: 2px;"
					onclick="toggle_benefit(false);" checked disabled><br> 
					
					<c:forEach items="${benefitList}" var="benefitList">
					
					<input type="text" readonly id="benefit_1" value="<c:if test="${not empty benefitList}"><c:out value="${benefitList.benefit1}" default=""/></c:if>" name="benefit_1"
					style="width: 150px; height: 30px; display: inline-block; margin: 2px;"
					onchange="getNumber(this);" onkeyup="getNumber(this);"
					maxlength="13">
					원 <input type="text" readonly id="benefit_2"
					value="<c:if test="${not empty benefitList}"><c:out value="${benefitList.benefit2}" default=""/></c:if>" name="benefit_2"
					style="width: 150px; height: 30px; display: inline-block; margin: 2px;"
					onchange="getNumber(this);" onkeyup="getNumber(this);"
					maxlength="13">원<br> <input type="text" readonly id="benefit_3"
					value="<c:if test="${not empty benefitList}"><c:out value="${benefitList.benefit3}" default=""/></c:if>" name="benefit_3"
					style="width: 150px; height: 30px; display: inline-block; margin: 2px;"
					onchange="getNumber(this);" onkeyup="getNumber(this);"
					maxlength="13">원 <input type="text" readonly id="benefit_4"
					...
					value="1" style="text-align: center" disabled>, 근로자 명의 예금통장에 입금 <input
					type="radio" onkeyup="setValue();" id="for_account" name="payfor"
					value="2" style="text-align: center" checked disabled>
			</div>
			<br>
			<br>
			<div class="col-sm-12" style="margin-top: 10px;">
			...
			<div class="col-sm-12" style="margin-top: 10px;">
				8. 사회보험 적용여부(해당란에 체크)<br> <input type="checkbox"
					...
					value="1" disabled><label for="employment_insurance">고용보험</label> <input
					type="checkbox" onkeyup="setValue();" name="ac_insurance"
					id="ac_insurance" value="1" disabled><label for="accident_insurance">산재보험</label>
				<input type="checkbox" onkeyup="setValue();" name="pension"
					id="pension" value="1" disabled><label for="national_pension">국민연금</label>
				<input type="checkbox" onkeyup="setValue();" name="hlt_insurance"
					id="hlt_insurance" value="1" disabled><label for="health_insurance">건강보험</label>
			</div>
			<br>
			<br>
			<div class="col-sm-12">
			...
			<div class="col-sm-12" style="text-align: right">
				...
				<input type="text" onkeyup="setValue();" id="contract_year"
					value="<c:out value="${contentList.contractYear}"/>" name="contract_year" readonly
					style="width: 60px; height: 30px; display: inline-block;"
					maxlength="4">년 <input type="text" onkeyup="setValue();"
					id="contract_month" value="<c:out value="${contentList.contractMonth}"/>"
					name="contract_month" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">월 <input type="text" onkeyup="setValue();"
					id="contract_day" value="<c:out value="${contentList.contractDay}"/>" name="contract_day" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">일<br>
				<br>(사업주) 사업체명: <input type="text" onkeyup="setValue();"
					id="company_name" value="<c:out value="${companyList.companyName}"/>" name="company_name" readonly
					style="width: 150px; height: 30px; display: inline-block;"
					...
					value="<c:out value="${companyList.companyAddress}"/>" name="company_address" readonly
