...
<div class="container">
	<div class="row">
		...
		<form action="/contract/template/contract2.do" method="post"
			...
			<br>
			<div class="col-sm-12" style="margin-top: 10px;">
				2. 근무장소: <input type="text" id="work_place" name="work_place"
					value="<%=work_place%>"
					style="width: 350px; height: 30px; display: inline-block;"
					maxlength="50">
			</div>
			<div class="col-sm-12" style="margin-top: 10px;">
				3. 업무의 내용: <input type="text" id="content" name="content"
					value="<%=content%>"
					style="width: 350px; height: 30px; display: inline-block;"
					maxlength="50">
			</div>
			<div class="col-sm-12" style="margin-top: 10px;">
				4. 소정근로시간: <input type="text" id="start_hour" name="start_hour"
					value="<%=start_hour%>"
					style="width: 30px; height: 30px; display: inline-block;"
			...
			<br>
			<div class="col-sm-12">
				6. 임금<br> - <select id="pay_type" name="pay_type"
					value="<%=pay_type%>"
					style="width: 60px; height: 30px; display: inline-block;">
			...
			<div class="col-sm-12" style="margin-top: 10px;">
				8. 사회보험 적용여부(해당란에 체크)<br> <input type="checkbox"
					...
					for="employment_insurance">고용보험</label> <input type="checkbox"
					name="ac_insurance" id="ac_insurance" value="1"><label
					for="accident_insurance">산재보험</label> <input type="checkbox"
					name="pension" id="pension" value="1"><label
					for="national_pension">국민연금</label> <input type="checkbox"
			...
			<div class="col-sm-12" style="text-align: right">
				...
				<input type="text" id="contract_year" value="<%=contract_year%>"
					name="contract_year"
					style="width: 60px; height: 30px; display: inline-block;"
					maxlength="4">년 <input type="text" id="contract_month"
					value="<%=contract_month%>" name="contract_month"
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">월 <input type="text" id="contract_day"
					value="<%=contract_day%>" name="contract_day"
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">일<br>
				<br>(사업주) 사업체명: <input type="text" id="company_name"
					value="<%=company_name%>" name="company_name"
					style="width: 150px; height: 30px; display: inline-block;"
					maxlength="20">(전화: <input type="text" id="company_num"
