...
<div class="container">
   <div class="row">
      ...
      <form action="/ec/template/contract.do" method="post" id="frm" name="frm" onsubmit="return Check()">  <!-- 자기자신에게 input에 입력된 값을 보낸다. -->
      <div class="col-sm-12">
      <input type="text" onkeyup="setValue();" id="admin_id" name="admin_id" style="width:150px; height:30px;display: inline-block;">
      (이하 "사업주"라 함)과(와)
      <input type="text" onkeyup="setValue();" id="user_id" name="user_id" style="width:80px; height:30px;display: inline-block;">
      ...
      <div class="col-sm-12">
      2. 근무장소:
      <input type="text" onkeyup="setValue();" id="location" name="location" style="width:350px; height:30px;display:inline-block;"></div>
      <div class="col-sm-12" style="margin-top:10px;">
      3. 업무의 내용:
      <input type="text" onkeyup="setValue();" id="contents" name="contents" style="width:350px;height:30px;display:inline-block;"></div>
      <div class="col-sm-12" style="margin-top:10px;">
      4. 소정근로시간:
      <input type="text" onkeyup="setValue();" id="start_time" name="start_time" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
      ...
      <input type="text" onkeyup="setValue();" id="end_time" name="end_time" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
      ...
      <input type="text" onkeyup="setValue();" id="break_start_time" name="break_start_time" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
      <input type="text" onkeyup="setValue();" id="break_start_min" name="break_start_min" style="width:30px;height:30px;display:inline-block;"maxlength="2">분~
      <input type="text" onkeyup="setValue();" id="break_end_time" name="break_end_time" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
      <input type="text" onkeyup="setValue();" id="break_end_min" name="break_end_min" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</div><br><br>
      <div class="col-sm-12">
      5. 근무일/휴일:매주
      <select id="work_per_week" onkeyup="setValue();" name="work_per_week" style="width:40px;height:30px;display:inline-block;"onchange="setWPW(this.value)">
        ...
        <select name="holiday" onkeyup="setValue();" style="width:40px;height:30px;display:inline-block;">
        ...
        <div class="col-sm-12">
        6. 임금<br> - 
        <select name="pay" onkeyup="setValue();"style="width:60px;height:30px;display:inline-block;">
           <option value="1">월급</option>
           <option value="2">주급</option>
           <option value="3">시급</option>
        </select> : 
        <input type="text" onkeyup="setValue();" id="pay_money" name="pay_money" style="width:150px;height:30px;display:inline-block;" onchange="getNumber(this);"
        ...
        <input type="text" onkeyup="setValue();"id="bonus" name="bonus" style="width:150px;height:30px;display:inline-block;margin:2px;" onchange="getNumber(this);"
      ...
      <input type="text" onkeyup="setValue();" id="company_name" name="company_name" style="width:150px;height:30px;display:inline-block;">(전화:
      <input type="text" onkeyup="setValue();" id="company_num" name="company_num" style="width:120px;height:30px;display:inline-block;">)<br>주 소:
      <input type="text" onkeyup="setValue();" id="company_address" name="company_address" style="width:250px;height:30px;display:inline-block;"><br>대 표 자:
      <input type="text" onkeyup="setValue();" id="admin_name" name="admin_name" style="width:80px;height:30px;display:inline-block;"><br>(근로자) 주 소:
      <input type="text" onkeyup="setValue();" id="user_address" name="user_address" style="width:250px;height:30px;display:inline-block;"><br>연 락 처:
      <input type="text" onkeyup="setValue();" id="user_num" name="user_num" style="width:120px;height:30px;display:inline-block;"><br>성 명:
      <input type="text" onkeyup="setValue();" id="user_name" name="user_name" style="width:80px;height:30px;display:inline-block;">
      </div>
