...
<div id="wrapper">
	...
	<!--사이드 메뉴부분-->
        <nav class="navbar navbar-expand-lg navbar-dark bg-basic fixed-top" id="sideNav">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="/page/main.do">HOME</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="/page/contract/contlist.do">계약서관리</a></li>
                </ul>
            </div>
        </nav>
        <!-- 사이드메뉴 끝  -->
