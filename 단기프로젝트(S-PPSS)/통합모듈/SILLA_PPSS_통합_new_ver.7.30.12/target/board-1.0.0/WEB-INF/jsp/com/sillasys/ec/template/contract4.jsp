...
<div class="container">
	<div class="row">
		...
		<form action="/ec/template/contract4.do" method="post" name="frm" onsubmit="return Check()">  <!-- 자기자신에게 input에 입력된 값을 보낸다. -->

		<div class="col-sm-12">
		<input type="text" id="admin_id" value="<%=admin_id %>" name="admin_id" style="width:150px; height:30px;display: inline-block;">
		(이하 "사업주"라 함)과(와)
		<input type="text" id="user_id" value="<%=user_id %>"name="user_id" style="width:80px; height:30px;display: inline-block;">
		...
		<div class="col-sm-12" style="margin-top:10px;">
		2. 근무장소:
		<input type="text" id="location" value="<%=location %>"name="location" style="width:350px; height:30px;display:inline-block;"></div>
		<div class="col-sm-12" style="margin-top:10px;">
		3. 업무의 내용:
		<input type="text" id="contents" value="<%=contents %>"name="contents" style="width:350px;height:30px;display:inline-block;"></div>
		<div class="col-sm-12" style="margin-top:10px;">
		...
		<div class="col-sm-12">
			<table class="table table-bordered">
				<tr>
					<td></td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_1" onkeyup="setValue();" value="<%=work_day_1 %>" name="work_day_1" style="width:30px;height:30px;display:inline-block;">요일</td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_2" onkeyup="setValue();" value="<%=work_day_2 %>" name="work_day_2" style="width:30px;height:30px;display:inline-block;">요일</td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_3" onkeyup="setValue();" value="<%=work_day_3 %>" name="work_day_3" style="width:30px;height:30px;display:inline-block;">요일</td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_4" onkeyup="setValue();" value="<%=work_day_4 %>" name="work_day_4" style="width:30px;height:30px;display:inline-block;">요일</td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_5" onkeyup="setValue();" value="<%=work_day_5 %>" name="work_day_5" style="width:30px;height:30px;display:inline-block;">요일</td>
					<td style="text-align:center;padding:0px;"><input type="text" id="work_day_6" onkeyup="setValue();" value="<%=work_day_6 %>" name="work_day_6" style="width:30px;height:30px;display:inline-block;">요일</td>
				</tr>
				<tr>
					<td style="text-align:center;padding:0px;">근로시간</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_time_1" onkeyup="setValue();" value="<%=work_time_1 %>" name="work_time_1" style="width:30px;height:30px;display:inline-block;"maxlength="2">시간</td>
				...
				<tr>
					...
					<td style="text-align:right;padding:0px;"><input type="text" id="work_start_time_1" onkeyup="setValue();" value="<%=work_start_time_1 %>" name="work_start_time_1" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_start_min_1" value="<%=work_start_min_1 %>" name="work_start_min_1" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_start_time_2" onkeyup="setValue();" value="<%=work_start_time_2 %>" name="work_start_time_2" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_start_min_2" value="<%=work_start_min_2 %>" name="work_start_min_2" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_start_time_3" onkeyup="setValue();" value="<%=work_start_time_3 %>" name="work_start_time_3" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_start_min_3" value="<%=work_start_min_3 %>" name="work_start_min_3" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_start_time_4" onkeyup="setValue();" value="<%=work_start_time_4 %>" name="work_start_time_4" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_start_min_4" value="<%=work_start_min_4 %>" name="work_start_min_4" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_start_time_5" onkeyup="setValue();" value="<%=work_start_time_5 %>" name="work_start_time_5" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_start_min_5" value="<%=work_start_min_5 %>" name="work_start_min_5" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_start_time_6" onkeyup="setValue();" value="<%=work_start_time_6 %>" name="work_start_time_6" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_start_min_6" value="<%=work_start_min_6 %>" name="work_start_min_6" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
				</tr>
				<tr>
					<td style="text-align:center;padding:0px;">종업</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_end_time_1" onkeyup="setValue();" value="<%=work_end_time_1 %>" name="work_end_time_1" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_end_min_1" onkeyup="setValue();" value="<%=work_end_min_1 %>" name="work_end_min_1" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_end_time_2" onkeyup="setValue();" value="<%=work_end_time_2 %>" name="work_end_time_2" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_end_min_2" onkeyup="setValue();" value="<%=work_end_min_2 %>" name="work_end_min_2" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_end_time_3" onkeyup="setValue();" value="<%=work_end_time_3 %>" name="work_end_time_3" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_end_min_3" onkeyup="setValue();" value="<%=work_end_min_3 %>" name="work_end_min_3" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_end_time_4" onkeyup="setValue();" value="<%=work_end_time_4 %>" name="work_end_time_4" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_end_min_4" onkeyup="setValue();" value="<%=work_end_min_4 %>" name="work_end_min_4" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_end_time_5" onkeyup="setValue();" value="<%=work_end_time_5 %>" name="work_end_time_5" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_end_min_5" onkeyup="setValue();" value="<%=work_end_min_5 %>" name="work_end_min_5" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="work_end_time_6" onkeyup="setValue();" value="<%=work_end_time_6 %>" name="work_end_time_6" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="work_end_min_6" onkeyup="setValue();" value="<%=work_end_min_6 %>" name="work_end_min_6" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
				</tr>
				<tr>
					<td style="text-align:center;padding:auto auto;">휴게 시간</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="break_start_time_1" onkeyup="setValue();" value="<%=break_start_time_1 %>" name="break_start_time_1" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_start_min_1" onkeyup="setValue();" value="<%=break_start_min_1 %>" name="break_start_min_1" style="width:30px;height:30px;display:inline-block;"maxlength="2">분<br>~
					<input type="text" id="break_end_time_1" onkeyup="setValue();" value="<%=break_end_time_1 %>" name="break_end_time_1" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_end_min_1" onkeyup="setValue();" value="<%=break_end_min_1 %>" name="break_end_min_1" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="break_start_time_2" onkeyup="setValue();" value="<%=break_start_time_2 %>" name="break_start_time_2" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_start_min_2" onkeyup="setValue();" value="<%=break_start_min_2 %>" name="break_start_min_2" style="width:30px;height:30px;display:inline-block;"maxlength="2">분<br>~
					<input type="text" id="break_end_time_2" onkeyup="setValue();" value="<%=break_end_time_2 %>" name="break_end_time_2" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_end_min_2" onkeyup="setValue();" value="<%=break_end_min_2 %>" name="break_end_min_2" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="break_start_time_3" onkeyup="setValue();" value="<%=break_start_time_3 %>" name="break_start_time_3" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_start_min_3" onkeyup="setValue();" value="<%=break_start_min_3 %>" name="break_start_min_3" style="width:30px;height:30px;display:inline-block;"maxlength="2">분<br>~
					<input type="text" id="break_end_time_3" onkeyup="setValue();" value="<%=break_end_time_3 %>" name="break_end_time_3" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_end_min_3" onkeyup="setValue();" value="<%=break_end_min_3 %>" name="break_end_min_3" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="break_start_time_4" onkeyup="setValue();" value="<%=break_start_time_4 %>" name="break_start_time_4" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_start_min_4" onkeyup="setValue();" value="<%=break_start_min_4 %>" name="break_start_min_4" style="width:30px;height:30px;display:inline-block;"maxlength="2">분<br>~
					<input type="text" id="break_end_time_4" onkeyup="setValue();" value="<%=break_end_time_4 %>" name="break_end_time_4" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_end_min_4" onkeyup="setValue();" value="<%=break_end_min_4 %>" name="break_end_min_4" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="break_start_time_5" onkeyup="setValue();" value="<%=break_start_time_5 %>" name="break_start_time_5" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_start_min_5" onkeyup="setValue();" value="<%=break_start_min_5 %>" name="break_start_min_5" style="width:30px;height:30px;display:inline-block;"maxlength="2">분<br>~
					<input type="text" id="break_end_time_5" onkeyup="setValue();" value="<%=break_end_time_5 %>" name="break_end_time_5" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_end_min_5" onkeyup="setValue();" value="<%=break_end_min_5 %>" name="break_end_min_5" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
					<td style="text-align:right;padding:0px;"><input type="text" id="break_start_time_6" onkeyup="setValue();" value="<%=break_start_time_6 %>" name="break_start_time_6" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_start_min_6" onkeyup="setValue();" value="<%=break_start_min_6 %>" name="break_start_min_6" style="width:30px;height:30px;display:inline-block;"maxlength="2">분<br>~
					<input type="text" id="break_end_time_6" onkeyup="setValue();" value="<%=break_end_time_6 %>" name="break_end_time_6" style="width:30px;height:30px;display:inline-block;"maxlength="2">시
					<input type="text" id="break_end_min_6" onkeyup="setValue();" value="<%=break_end_min_6 %>" name="break_end_min_6" style="width:30px;height:30px;display:inline-block;"maxlength="2">분</td>
			</table>
		</div>
		<div class="col-sm-12">
		ㅇ 주휴일 매주
		...
		<input type="text" id="company_name" onkeyup="setValue();" value="<%=company_name %>" name="company_name" style="width:150px;height:30px;display:inline-block;">(전화:
		<input type="text" id="company_num" onkeyup="setValue();" value="<%=company_num %>" name="company_num" style="width:120px;height:30px;display:inline-block;">)<br>주 소:
		<input type="text" id="company_address" onkeyup="setValue();" value="<%=company_address %>" name="company_address" style="width:250px;height:30px;display:inline-block;"><br>대 표 자:
		<input type="text" id="admin_name" onkeyup="setValue();" value="<%=admin_name %>" name="admin_name" style="width:80px;height:30px;display:inline-block;"><br>(근로자) 주 소:
		<input type="text" id="user_address" onkeyup="setValue();" value="<%=user_address %>" name="user_address" style="width:250px;height:30px;display:inline-block;"><br>연 락 처:
		<input type="text" id="user_num" onkeyup="setValue();" value="<%=user_num %>" name="user_num" style="width:120px;height:30px;display:inline-block;"><br>성 명:
