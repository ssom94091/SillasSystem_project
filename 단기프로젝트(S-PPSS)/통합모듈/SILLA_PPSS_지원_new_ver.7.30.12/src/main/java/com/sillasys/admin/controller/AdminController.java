...
public class AdminController {
	...
	public String doLogout(HttpServletRequest request, Model model) {
		...
		/*
		 * 세션에 저장된 값의 키값들을 불러온다. (db의 컬럼내용) loginAdmin.keySet(), .get을 통하여 해당 키의 값을
		 * 가지고온다.
		 */
	...
	// 관리자로그인페이지 이동
	@RequestMapping(value = "/template/template1.do", method = RequestMethod.GET) 
	public String gotemplate1() throws Exception {
		return "com/sillasys/template/template1";
	}
	...
	// 양식보관함 페이지 이동
	@RequestMapping(value = "/template/contract/contlist.do", method = RequestMethod.GET)
	public String gocontList() throws Exception {
		return "com/sillasys/template/contract/contlist";
	}
	
	// 계약서 목록 페이지 이동
	@RequestMapping(value = "/template/contract/form.do", method = RequestMethod.GET)
	public String goForm() throws Exception {
		return "com/sillasys/template/contract/form";
	}
