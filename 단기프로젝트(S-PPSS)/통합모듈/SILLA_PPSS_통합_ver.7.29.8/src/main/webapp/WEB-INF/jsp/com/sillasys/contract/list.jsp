				...
				<table class="table" style="text-align: center; border: 1px solid #dddddd;">
					...
					<tbody id="tbody">
						...
						<tr>
							...
							<td><button type="button" class="btn btn-danger"id="delete" name="delete" onclick="deleteContract(<c:out value="${contentList.contractPk}"/>);">삭제</button>
								<input type="hidden" id="deletebtn" name="deletebtn" value="<c:out value="${contentList.contractPk}"/>"></td>
