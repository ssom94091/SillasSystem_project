...
<div class="container">
	<div class="row">
		...
		<form action="/contract/template/contract1.do" method="post" id="frm1"
			name="frm1" onsubmit="return Check()">
			<!-- 자기자신에게 input에 입력된 값을 보낸다. -->
			<div class="col-sm-12">
				<input type="hidden" id="contract_type" name="contract_type"
					value="표준(기간있음)"> <input type="hidden" id="contract_pk"
			...
			<div class="col-sm-12">
				1. 근로계약기간: 
				<input type="text" onkeyup="setValue();" id="start_year"
					value="<c:out value="${result.startYear}"/>" name="start_year" readonly
					style="width: 60px; height: 30px; display: inline-block;"
					maxlength="4"> 년
				<input type="text" onkeyup="setValue();"
					id="start_month" value="<c:out value="${result.startMonth}"/>" name="start_month" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2"> 월 
				<input type="text" onkeyup="setValue();"
					id="start_day" value="<c:out value="${result.startDay}"/>" name="start_day" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2"> 일부터
				 <input type="text" onkeyup="setValue();"
					id="end_year" value="<c:out value="${result.endYear}"/>" name="end_year" readonly
					style="width: 60px; height: 30px; display: inline-block;"
					maxlength="4"> 년 
				<input type="text" onkeyup="setValue();"
					id="end_month" value="<c:out value="${result.endMonth}"/>" name="end_month" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2"> 월 
				<input type="text" onkeyup="setValue();"
					id="end_day" value="<c:out value="${result.endDay}"/>" name="end_day" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2"> 일까지<br>※ 근로계약기간을 정하지 않는 경우에는 "근로개시일"만 기재
			</div>
			<br>
			
			<div class="col-sm-12">
				2. 근무장소: <input type="text" onkeyup="setValue();" id="work_place" readonly
					value="<c:out value="${result.workPlace}"/>" name="work_place"
			...
			<div class="col-sm-12" style="margin-top: 10px;">
				3. 업무의 내용: 
				<input type="text" onkeyup="setValue();" id="content" readonly
					value="<c:out value="${result.content}"/>" name="content"
					style="width: 350px; height: 30px; display: inline-block;"
					maxlength="50">
			</div>
			<div class="col-sm-12" style="margin-top: 10px;">
				4. 소정근로시간: 
				<input type="text" onkeyup="setValue();" id="start_hour" readonly
					value="<c:out value="${result.startHour}"/>" name="start_hour"
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">시 
				<input type="text" onkeyup="setValue();"
					id="start_min" value="<c:out value="${result.startMin}"/>" name="start_min" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">분부터 
				<input type="text" onkeyup="setValue();"
					id="end_hour" value="<c:out value="${result.endHour}"/>" name="end_hour" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">시 
				<input type="text" onkeyup="setValue();"
					id="end_min" value="<c:out value="${result.endMin}"/>" name="end_min" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">분까지 (휴게시간: 
				<input type="text"
					onkeyup="setValue();" id="b_start_hour" value="<c:out value="${result.bStartHour}"/>"
					name="b_start_hour" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">시 
				<input type="text" onkeyup="setValue();"
					id="b_start_min" value="<c:out value="${result.bStartMin}"/>" name="b_start_min" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">분~
				 <input type="text" onkeyup="setValue();"
					id="b_end_hour" value="<c:out value="${result.bEndHour}"/>" name="b_end_hour" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">시 
				<input type="text" onkeyup="setValue();"
					id="b_end_min" value="<c:out value="${result.bEndMin}"/>" name="b_end_min" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">분
			</div>
			...
			<div class="col-sm-12">
				5. 근무일/휴일:매주 
				<select id="work_per_week" onkeyup="setValue();"
					value="<c:out value="${result.workPerWeek}"/>" name="work_per_week" disabled
				...
				</select>일(또는 매일단위)근무,주휴일 매주 <select id="holiday" name="holiday"  disabled
					value="<c:out value="${result.holiday}"/>" onkeyup="setValue();"
					style="width: 40px; height: 30px; display: inline-block;">
			...
			<div class="col-sm-12">
				6. 임금<br> - 
				<select id="pay_type" value="<c:out value="${result.payType}"/>" disabled
				...
				- 상여금:있음
				 <input type="radio" onkeyup="setValue();" id="bonus_on"
					name="bonus_check" value="1" style="text-align: center" disabled
					onclick="toggle_bonus(true);"> 
				 <input type="text"
					maxlength="13" id="bonus" value=""<c:out value="${result.bonus}"/>" name="bonus"
					style="width: 150px; height: 30px; display: inline-block; margin: 2px;" readonly
					onchange="getNumber(this);" onkeyup="getNumber(this);"
					onkeyup="setValue();">원, 없음 
				<input type="radio"
					onkeyup="setValue();" id="bonus_off" name="bonus_check" value="2"
					style="text-align: center; margin: 2px;" disabled
					onclick="toggle_bonus(false);" checked><br> - 기타급여(제수당
				등):있음 
				<input type="radio" onkeyup="setValue();" id="benefit_on"
					name="benefit_check" value="1" style="text-align: center" disabled
					onclick="toggle_benefit(true);">없음 
				<input type="radio"
					onkeyup="setValue();" id="benefit_off" name="benefit_check"
					value="2" style="text-align: center; margin: 2px;" disabled
					onclick="toggle_benefit(false);" checked><br> 
				<input
					type="text" id="benefit_1" value="<c:out value="${result.benefit1}"/>" name="benefit_1"
					style="width: 150px; height: 30px; display: inline-block; margin: 2px;" readonly
					onchange="getNumber(this);" onkeyup="getNumber(this);"
					maxlength="13" readonly>원 
				<input type="text" id="benefit_2"
					value="<c:out value="${result.benefit2}"/>" name="benefit_2" readonly
					style="width: 150px; height: 30px; display: inline-block; margin: 2px;"
					onchange="getNumber(this);" onkeyup="getNumber(this);"
					maxlength="13">원<br> 
				<input type="text" id="benefit_3"
					value="<c:out value="${result.benefit3}"/>" name="benefit_3" readonly
					style="width: 150px; height: 30px; display: inline-block; margin: 2px;"
					onchange="getNumber(this);" onkeyup="getNumber(this);"
					maxlength="13">원 
				<input type="text" id="benefit_4"
					value="<c:out value="${result.benefit4}"/>" name="benefit_4" readonly
					style="width: 150px; height: 30px; display: inline-block; margin: 2px;"
					onchange="getNumber(this);" onkeyup="getNumber(this);"
					maxlength="13">원<br> - 임금지급일:매월(매주 또는 매일)
				 <input
					type="text" onkeyup="setValue();" id="payday" value="<c:out value="${result.payday}"/>"
					name="payday" readonly
					style="width: 30px; height: 30px; display: inline-block;"
					maxlength="2">일(휴일의 경우는 전일 지급)<br> - 지급방법:근로자에게 직접지급
				 <input
					type="radio" onkeyup="setValue();" id="for_worker" name="payfor" disabled
					value="1" style="text-align: center">, 근로자 명의 예금통장에 입금 
				<input
					type="radio" onkeyup="setValue();" id="for_account" name="payfor" disabled
			...
			<div class="col-sm-12" style="margin-top: 10px;">
			 ...
			 <input type="checkbox"
					onkeyup="setValue();" name="em_insurance" id="em_insurance" disabled
					value="1"><label for="employment_insurance">고용보험</label> 
			<input
					type="checkbox" onkeyup="setValue();" name="ac_insurance" disabled
					id="ac_insurance" value="1"><label for="accident_insurance">산재보험</label>
			<input type="checkbox" onkeyup="setValue();" name="pension" disabled
					id="pension" value="1"><label for="national_pension">국민연금</label>
			<input type="checkbox" onkeyup="setValue();" name="hlt_insurance" disabled
			...
			<div class="col-sm-12" style="text-align: right">
				...
				<input type="hidden" value="<c:out value="${result.canvas}"/>" id="canvas" name="canvas"> 

				<input type="text" onkeyup="setValue();" id="contract_year"
					value="<c:out value="${result.contractYear}"/>" name="contract_year"
					style="width: 60px; height: 30px; display: inline-block;" readonly
					maxlength="4">년 
				<input type="text" onkeyup="setValue();"
					id="contract_month" value="<c:out value="${result.contractMonth}"/>"
					name="contract_month"
					style="width: 30px; height: 30px; display: inline-block;" readonly
					maxlength="2">월 
				<input type="text" onkeyup="setValue();"
					id="contract_day" value="<c:out value="${result.contractDay}"/>" name="contract_day"
					style="width: 30px; height: 30px; display: inline-block;" readonly
					maxlength="2">일<br> <br>(사업주) 사업체명:
				 <input
				...
				<input type="text"
					...
					style="margin-top:5px;width: 350px; height: 30px; display: inline-block;"
					maxlength="40"><br>대 표 자: 
				<input type="text"
					onkeyup="setValue();" id="admin_name" value="<c:out value="${result.adminName}"/>"
					name="admin_name" readonly
					style="margin-top:5px; width: 80px; height: 30px; display: inline-block;"
					maxlength="7"><br>(근로자) 주 소: 
				<input type="text"
					onkeyup="setValue();" id="user_address" value="<c:out value="${result.userAddress}"/>"
					name="user_address" readonly
					style="margin-top:30px; width: 350px; height: 30px; display: inline-block;"
					maxlength="40"><br>연 락 처: 
				<input type="text"
					onkeyup="setValue();" id="user_num" value="<c:out value="${result.userPhone}"/>"
					name="user_num" readonly
					style="margin-top:5px;width: 150px; height: 30px; display: inline-block;"
					maxlength="20"><br>성 명: 
				<input type="text"
...
<div style="margin-top:20px; text-align:center;">
			<button class="btn btn-primary" type="submit" value="수정">수정</button>
			
			<button class="btn btn-danger" type="submit" value="취소">취소</button>
</div>
		</form>
	</div>
</div>
