...
<%
   ...
   request.setAttribute("start_min",start_min);
   request.setAttribute("end_time",end_time);
   request.setAttribute("end_min",end_min);
   request.setAttribute("break_start_time",break_start_time);
   request.setAttribute("break_start_min",break_start_min);
   request.setAttribute("break_end_time",break_end_time);
   request.setAttribute("work_per_week",work_per_week);
   request.setAttribute("holiday",holiday);
   request.setAttribute("pay",pay);
   request.setAttribute("pay_money",pay_money);
   request.setAttribute("bonus_check",bonus_check);
   request.setAttribute("bonus",bonus);
   request.setAttribute("benefit_check",benefit_check);
   request.setAttribute("benefit_1",benefit_1);
   request.setAttribute("benefit_2",benefit_2);
   request.setAttribute("benefit_3",benefit_3);
   request.setAttribute("benefit_4",benefit_4);
   request.setAttribute("payday",payday);
   request.setAttribute("payfor",payfor);
   request.setAttribute("employment_insurance",employment_insurance);
   request.setAttribute("accident_insurance",accident_insurance);
   request.setAttribute("national_pension",national_pension);
   request.setAttribute("health_insurance",health_insurance);
   request.setAttribute("contract_year",contract_year);
   request.setAttribute("contract_month",contract_month);
   request.setAttribute("contract_day",contract_day);
   request.setAttribute("company_name",company_name);
   request.setAttribute("company_num",company_num);
...
<div class="container">
   <div class="row">
      ...
      <input type="checkbox" id="employment_insurance" value=<%=employment_insurance%>><label for="employment_insurance">고용보험</label>
      <input type="checkbox" id="accident_insurance" value=<%=accident_insurance%>><label for="accident_insurance">산재보험</label>
      <input type="checkbox" id="national_pension" value=<%=national_pension%>><label for="national_pension">국민연금</label>
      <input type="checkbox" id="health_insurance" value=<%=health_insurance%>><label for="health_insurance">건강보험</label></div><br><br>
      <div class="col-sm-12">
...
window.onload=function(){
    ...
    console.log(<%=employment_insurance%>);
